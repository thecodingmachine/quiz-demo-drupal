...
$moufManager->getConfigManager()->setConstantsDefinitionArray(array (
  ...
  'SECRET' => 
  array (
    'defaultValue' => 'PXcjl6kKhPfP1JSRU3qA',
    'type' => 'string',
...
$moufManager->addComponentInstances(array (
  ...
  'drupalTemplate' => 
  array (
    'class' => 'Mouf\\Integration\\Drupal\\Druplash\\DrupalTemplate',
    'external' => false,
    'weak' => false,
    'setterBinds' => 
    array (
      'setContentBlock' => 'block.content',
      'setWebLibraryManager' => 'defaultWebLibraryManager',
      'setTemplateRenderer' => 'druplashRenderer',
      'setDefaultRenderer' => 'defaultRenderer',
    ),
  ),
  'druplash' => 
  array (
    'class' => 'Mouf\\Integration\\Drupal\\Druplash\\Druplash',
    'external' => false,
    'weak' => false,
    'constructor' => 
    array (
  ...
  array (
    ...
    array (
      0 => 
      array (
        'value' => 'vendor/mouf/integration.drupal.druplash/src/templates',
        'parametertype' => 'primitive',
        'type' => 'string',
        'metadata' => 
        array (
  ...
  'rightsService' => 
  array (
    'class' => 'Mouf\\Integration\\Drupal\\Druplash\\DruplashRightService',
    'external' => false,
    'weak' => false,
    'fieldBinds' => 
    array (
  ...
  'sessionManager' => 
  array (
    'class' => 'Mouf\\Integration\\Drupal\\Druplash\\DrupalSessionManager',
    'external' => false,
    'weak' => false,
  ),
  'twigCacheFileSystem' => 
...
return rtrim(sys_get_temp_dir(), \'/\\\\\').\'/mouftwigtemplatemain_\'.$posixGetuid.str_replace(":", "", ROOT_PATH);',
  ...
  'userService' => 
  array (
    'class' => 'Mouf\\Integration\\Drupal\\Druplash\\DruplashUserService',
    'external' => false,
    'weak' => false,
    'fieldBinds' => 
    array (
...
return rtrim(sys_get_temp_dir(), '/\\').'/mouftwigtemplatemain_'.$posixGetuid.str_replace(":", "", ROOT_PATH);
	...
	/**
	 * @return Mouf\Integration\Drupal\Druplash\DrupalTemplate
	 */
	 public static function getDrupalTemplate() {
	 	return MoufManager::getMoufManager()->get('drupalTemplate');
	 }

	/**
	 * @return Mouf\Integration\Drupal\Druplash\Druplash
	 */
	 public static function getDruplash() {
	 	return MoufManager::getMoufManager()->get('druplash');
	 }

	/**
	 * @return Mouf\Html\Renderer\FileBasedRenderer
	 */
	 public static function getDruplashRenderer() {
	 	return MoufManager::getMoufManager()->get('druplashRenderer');
	 }
	...
	/**
	 * @return Mouf\Integration\Drupal\Druplash\DruplashRightService
	 */
	...
	/**
	 * @return Mouf\Integration\Drupal\Druplash\DrupalSessionManager
	 */
	...
	/**
	 * @return Mouf\Integration\Drupal\Druplash\DruplashUserService
	 */
